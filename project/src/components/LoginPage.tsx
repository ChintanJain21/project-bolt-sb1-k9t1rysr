...
const LoginPage: React.FC = () => {
  ...
  const [isTransitioning, setIsTransitioning] = useState(false); // New state for transition period
  ...
  useEffect(() => {
    if (signUpSuccess || needsEmailVerification) {
      ...
      const switchTimer = setTimeout(() => {
        setIsSignUp(false);
        setIsTransitioning(false); // End transition - enable login fields
      }, 800);
  ...
  const toggleMode = () => {
    ...
    setIsTransitioning(false); // Reset transition state when manually switching
  };
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      disabled={isLoading || isTransitioning} // Only disabled during loading or brief transition
                    />
                  </div>
                </div>
